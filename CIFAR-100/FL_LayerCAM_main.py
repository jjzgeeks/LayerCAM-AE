...
from torchvision.models import resnet, resnet18, ResNet18_Weights, resnet50, ResNet50_Weights, regnet_y_800mf, RegNet_Y_800MF_Weights,\
    regnet_y_400mf, RegNet_Y_400MF_Weights, mobilenet_v3_large, MobileNet_V3_Large_Weights, efficientnet_b4, EfficientNet_B4_Weights
from torch.utils.data import Dataset, DataLoader
from FL_to_layercam import FL_to_Layer_CAM
...
def training(model, rounds, batch_size, lr, ds, data_dict, C, K, E, num_malicious, plt_title, plt_color, cifar_data_test,
    ...
    for curr_round in range(1, rounds+1):
        ...
        if curr_round % buffer_size != 0:
            ...
            predict_labels, recon_errors, threshold = FL_to_Layer_CAM(new_local_models, curr_round)  # elements in list is 0 or 1
            ...
            predict_labels,  recon_errors, threshold = FL_to_Layer_CAM(new_local_models, curr_round)
            buffer.append(predict_labels)
            recsrt.append(recon_errors)
            thresholds.append(threshold)
            # sum buffer by row
    ...
    # save data as mat
    savemat("./FL_Layercam_cifar100_results_{}_{}_{}_{}.mat".format(partition, rounds, m, num_malicious),
...
if __name__ == '__main__':
    ...
    data_train = datasets.CIFAR100(root='./data', train=True, download=True, transform=transforms_train)
    data_test = datasets.CIFAR100(root='./data', train=False, download=True, transform=transforms_test)
    ...
    num_clients = 21
    num_malicious = 3
    num_epochs = 25 # 25, 20  # the number of local clients training epochs
    #client_batch_size = 64
    client_lr = 1e-4 #2e-5, 1e-4 # client learning rate
    alpha_partition = 0.5 #0.1, 0.3, 0.5, 0.7, 0.9
